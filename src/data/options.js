export const leatherColors = [
  { id: 'tan', name: '蜜蜡棕', hex: '#C4956A', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&h=200&fit=crop', price: 0 },
  { id: 'black', name: '经典黑', hex: '#2C2C2C', image: 'https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=200&h=200&fit=crop', price: 0 },
  { id: 'burgundy', name: '酒红色', hex: '#7B2D26', image: 'https://images.unsplash.com/photo-1586953208270-767889fa9b6f?w=200&h=200&fit=crop', price: 30 },
  { id: 'navy', name: '深海蓝', hex: '#1E3A5F', image: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=200&h=200&fit=crop', price: 30 },
  { id: 'green', name: '森林绿', hex: '#2D5A3D', image: 'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=200&h=200&fit=crop', price: 50 },
  { id: 'cognac', name: '干邑色', hex: '#8B4513', image: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=200&h=200&fit=crop', price: 40 }
]
...
export const materialStock = {
  leather: {
    tan: { sheet: 20, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } },
    black: { sheet: 18, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } },
    burgundy: { sheet: 8, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } },
    navy: { sheet: 10, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } },
    green: { sheet: 5, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } },
    cognac: { sheet: 6, unit: '张', perProduct: { keychain: 0.05, cardholder: 0.1, wallet: 0.2, passport: 0.15 } }
  },
  hardware: {
    gold: { count: 80, unit: '套' },
    silver: { count: 120, unit: '套' },
    rose: { count: 45, unit: '套' },
    gunmetal: { count: 60, unit: '套' }
  },
  thread: {
    beige: { spool: 15, unit: '卷' },
    black: { spool: 12, unit: '卷' },
    brown: { spool: 10, unit: '卷' },
    navy: { spool: 6, unit: '卷' }
  }
}
